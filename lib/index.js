...
var ClampLines = function (_PureComponent) {
  ...
  _createClass(ClampLines, [{
    ...
    value: function clickHandler(e) {
      ...
      this.watch ? this.clampLines() : this.setState({
        text: this.original
      });
    ...
    value: function render() {
      ...
      var innerClampElement = _react2.default.createElement(this.props.innerElement, {
        ref: function ref(e) {
          _this3.element = e;
        },
