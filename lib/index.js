...
var NanoClamp = function (_PureComponent) {
  _inherits(NanoClamp, _PureComponent);
  ...
  _createClass(NanoClamp, [{
    ...
    value: function clampLines() {
      ...
      this.setState({ text: '' }, function () {
        var maxHeight = _this3.lineHeight * _this3.props.lines + 1;

        _this3.start = 0;
        _this3.middle = 0;
        _this3.end = _this3.original.length;

        while (_this3.start <= _this3.end) {
          _this3.middle = Math.floor((_this3.start + _this3.end) / 2);
          _this3.element.innerText = _this3.original.slice(0, _this3.middle);
          if (_this3.middle === _this3.original.length) {
            _this3.setState({
              text: _this3.original,
              noClamp: true
            });
            return;
          }

          _this3.moveMarkers(maxHeight);
        }

        _this3.setState(function () {
          var slicedString = _this3.original.slice(0, _this3.middle - 5);
          var text = slicedString.trim() + ELLIPSIS;
          return {
            text: text
          };
        }, function () {
    ...
    value: function render() {
      ...
      return (0, _react.createElement)(is, props, text);
    }
  }]);
